package co.kr.school.programmers.codingtest.lessons.lv0;
...
public class Lesson_120956 {
    ...
    public Lesson_120956() {
        ...
        String[] babblingCase1 = {"aya", "yee", "u", "maa"};
        solution.solution(babblingCase1);
        String[] babblingCase2 = {"ayaye", "uuu", "yeye", "yemawoo", "ayaayaa"};
        solution.solution(babblingCase2);
        String[] babblingCase3 = {"ayaye", "ayayewoomawooma", "yeye", "yemawoo", "ayaayaa"};
        solution.solution(babblingCase3);
    }
